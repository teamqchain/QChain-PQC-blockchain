...
echo "               -d '{\"holderEmiratesID\":\"784-1990-1234567-1\",\"credentialType\":\"BSc CS\",\"info\":\"{\\\"College\\\":\\\"CCI\\\",\\\"expiryDate\\\":\\\"30 Jun 2030\\\"}\"}'"
echo "               (the holder must have activated QWallet first — keys bound on-chain)"
echo "  Detail   : curl -s 'http://localhost:3000/getCredentialDetail?credentialID=CRED-0001'"
echo "  Verify   : present from QWallet (QR/OTP) and scan in QPortal, or run: bash tests/e2e_api_test.sh"
